...
int main()
{
    ...
    cout << endl;
    cout<<"A messenger runs into you and falls before quickly getting back on his feet."<<endl;
    ...
    cout << endl;
    cout<<"\"I'd be careful wandering around here. They say a dragon leaves on the mountain!"<<endl;
    cout<<"The merchant says he has a sword to kill it, but he won't kill it himself"<<endl;
    cout<<"and he;s asking way to much for it! You could talk to him if you want!"<<endl;
    cout<<"See you later!\""<<endl;
    cout << endl;
    cout<<"Looking around you see the merchant, some little shacks, and three roads leading away."<<endl;
    cout << endl;
    cout << "If this is your first time playing, type \"help\" for instructions. " << endl << endl;
    while(input!="q")
    {
        ...
        while(location=="resturant")
        {
            ...
            if(input=="talk")
            {
                ...
                cout<<"Unfortunately we're closed right now."<<endl;
...
void help()
{
    ...
    {
        cout << endl;
        cout << "Welcome to the Adventure, traveller!" << endl;
        cout << "As a hero, you have several options available to you at each junction:" << endl;
        cout << "Go <direction>: Go North, South, East or West." << endl;
        cout << "Look: Get more details about the location." << endl;
        cout << "Talk: Talk to the NPC at your current location. " << endl;
        cout << "Look at map: Find locations you can \"Go\" to from this location." << endl;
        cout << "Look in bag: Display inventory." << endl;
        cout << "Buy <item>: Buy an item while talking to a shopkeeper" << endl;
        cout << "Trade: Trade an NPC the item they require." << endl;
        cout << "Pick up: Pick up an item on the ground at your location" << endl;
        cout << "Fight: Fight a monster, if one is nearby" << endl;
        cout << "Leave: Leave your current location" << endl;
        cout << "q: Quit the game." << endl;
        cout << endl;
        cout << "Did you get all that? (Y/N)" << endl;
        getline(cin,userIn);
